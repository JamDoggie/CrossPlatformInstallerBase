...
namespace CrossPlatformInstallerBase.controls
{
    /// <summary>
    ...
    public class SmoothScrollViewer : ContentControl, IScrollable, IScrollAnchorProvider
    {
        ...
        public static readonly StyledProperty<IEasing> SmoothScrollEasingProperty =
            AvaloniaProperty.Register<SmoothScrollViewer, IEasing>(nameof(SmoothScrollEasing));
        /*public static readonly DirectProperty<SmoothScrollViewer, Easing> SmoothScrollEasingProperty =
            AvaloniaProperty.RegisterDirect<SmoothScrollViewer, Easing>(
        ...
        /*public static readonly DirectProperty<SmoothScrollViewer, TimeSpan> SmoothScrollDurationProperty =
            AvaloniaProperty.RegisterDirect<SmoothScrollViewer, TimeSpan>(
        ...
        {
            HorizontalScrollBarVisibilityProperty.Changed.AddClassHandler<SmoothScrollViewer>((x, e) => x.ScrollBarVisibilityChanged(e));
            VerticalScrollBarVisibilityProperty.Changed.AddClassHandler<SmoothScrollViewer>((x, e) => x.ScrollBarVisibilityChanged(e));
            ...
            SmoothScrollEasingProperty.Changed.AddClassHandler<SmoothScrollViewer>((x, e) =>
            {
                Console.WriteLine($"SmoothScrollViewer \'{x.Name}\':\n\tOld: {e.OldValue}\n\tNew: {e.NewValue}\n");
            });
        }
